...
<html lang="es" ng-app>
  <head>
    ...
    <meta property="og:description" content="Aprendamos a usar Windows como se debe!">
  ...
  <body class="page-overview">
    ...
    <div id="initm">
      ...
      <hr>
      <h2>Es el 'OS' mas usado en el mundo, usemoslo bien...</h2>
    ...
    <div id="pub"></div><?php
     $query="SELECT * FROM tnotes WHERE type = 'win' ORDER BY date DESC";
