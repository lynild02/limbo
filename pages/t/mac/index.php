...
<html lang="es" ng-app>
  <head>
    <title>LC - MacOS -Tutorials</title>
    <meta charset="utf-8">
  ...
  <body class="page-overview">
    ...
    <div id="initm">
      <h3 class="dotmac">MacOS</h3>
      <hr>
      <h2>Seguridad, estabilidad, diseño y usabilidad... hablemos de Manzanas <span></span></h2>
    ...
    <div id="pub"></div><?php
     $query="SELECT * FROM tmac ORDER BY date DESC";
