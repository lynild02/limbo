...
<html lang="es" ng-app>
  <head>
    ...
    <meta property="og:description" content="Uso un Mac y claro que saco jugo!!!!">
  ...
  <body class="page-overview">
    ...
    <div id="initm">
      <h3 class="dot">MacOS</h3>
      <hr>
      <h2>Diseño, Funcionalidad y Estabilidad... Hablemos de Manzanas.</h2>
    ...
    <div id="pub"></div><?php
     $query="SELECT * FROM tnotes WHERE type = 'mac' ORDER BY date DESC";
