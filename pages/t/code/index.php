...
<html lang="es" ng-app>
  <head>
    ...
    <meta property="og:description" content="Quiero programar mi vida, con unos cuantos bugs... solo para darle sabor!">
  ...
  <body class="page-overview">
    ...
    <div id="initm">
      ...
      <hr>
      <h2>Conectando personas con lineas de <code>&lt;Codigo.../&gt;</code></h2>
    ...
    <div id="pub"></div><?php
     $query="SELECT * FROM tnotes WHERE type = 'code' ORDER BY date DESC";
