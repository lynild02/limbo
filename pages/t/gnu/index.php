...
<html lang="es" ng-app>
  <head>
    <title>LC - GNU/Linux -Tutorials</title>
    <meta charset="utf-8">
  ...
  <body class="page-overview">
    ...
    <div id="initm">
      <h3 class="dot">Linux</h3>
      <hr>
      <h2>Uno de los sistemas operativos mas utiles, pero tambien complicados... hasta ahora.</h2>
    ...
    <div id="pub"></div><?php
     $query="SELECT * FROM tgnu ORDER BY date DESC";
