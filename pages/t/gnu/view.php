...
$id  = evaluar($_GET['id']);
$cdb  = $tconexion->query("SELECT * FROM tgnu WHERE id=$id");
$row = $cdb->fetch_assoc();
$tl=$row['title'];
$au=$row['author'];
$dt=$row['date'];
    ...
    <article class="container">
      ...
      <div class="all-body">
        <div class="main-content">
          ...
          <div class="author-f">   
            <div class="img-c"><img data-original="<?=$iau?>" class="lazy"></div>
            <div class="inf-c"><span class="nau"><a href="<?=$nau?>"><?=$nau?><br></a></span>
              <p><?=$infau?></p>
              <p class="tt"><a href="<?=$mau?>"><?=$nau?>&nbsp;&mdash;&nbsp;</a></p>
            </div>
          </div>
          <div class="last-art">
            <div class="row"><?php
               $query="SELECT * FROM tgnu ORDER BY date DESC LIMIT 0, 3";
