...
<html lang="es">
  ...
  <body class="page-overview">
    ...
    <div id="fullpage">
      <div id="head" class="hwrapp section">
        <div class="title">
          <h3>Acerca de LC</h3>
          <h3 class="indief i">About LC</h3>
        </div>
      </div>
      <div id="contenedor" class="section">
        <article class="container">
          <table class="u-full-width">
            ...
            <tbody>
              <tr>
                <td><a href='theidea.php'>Projecto Limbo City</a></td>
                <td><a href='#'>Limbo City</a></td>
                <td><a href='#'>Diseño</a></td>
                <td><a href='#'>Izúcar de Matamoros</a></td>
              </tr>
              <tr>
                <td><a href='#'>Lynild02</a></td>
                <td><a href='#'>Lynild</a></td>
                <td><a href='#'>Programación</a></td>
              </tr>
              <tr>
                <td><a href='#'>Privacidad</a></td>
                <td><a href='#'>Arte</a></td>
                <td><a href='#'>Artistica</a></td>
              </tr>
              <tr>
      ...
      <footer class="section">
        <article class="container">
          <h3>Limbo City</h3>
          <h4>Servicios Digitales Multiples.</h4>
          <hr>
          <div class="row">
